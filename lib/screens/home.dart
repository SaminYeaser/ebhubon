...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  fetchAllCategory() async {
    var allCategoryResponse = await CategoryRepository().getCategories();
    _allCategoryList.addAll(allCategoryResponse.categories);
    setState(() {});
  }
    ...
    return WillPopScope(
      ...
      child: Directionality(
        ...
        child: Scaffold(
            ...
            drawer: MainDrawer(),
            body: SafeArea(
    child: WebView(initialUrl: 'https://ebhubon.net/',
